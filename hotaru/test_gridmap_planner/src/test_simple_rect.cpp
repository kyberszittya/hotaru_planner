...
int main(int argc, char ** argv)
{
	...
	map.setGeometry(grid_map::Length(10.0, 10.0), 0.5);
	...
	state.goal.pose.position.x = 2.0;
	...
	wp1.pose.pose.position.x = 2.0;
	wp1.pose.pose.position.y = 2.0;
